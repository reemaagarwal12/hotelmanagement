...
<div class="banner-top">
			...
			<div class="contact-bnr-w3-agile">
				<ul>
					<li><i class="fa fa-envelope" aria-hidden="true"></i><a href="mailto:info@example.com">reemasmu1398@gmail.com</a></li>
					<li><i class="fa fa-phone" aria-hidden="true"></i>+91-7426931082</li>	
					<li class="s-bar">
						<div class="search">
		...
		<div class="container">
			<nav class="navbar navbar-default">
				<div class="navbar-header navbar-left">
					...
					<h1><a class="navbar-brand" href="index.php">ANNAPURNA<p class="logo_w3l_agile_caption">Your Dreamy Resort</p></a></h1>
				</div>
				...
				<ul class="cbp-ig-grid">
					<li>
						<div class="w3_grid_effect">
							...
							<span class="cbp-ig-category">ANNAPURNA</span>
						</div>
					</li>
					<li>
						<div class="w3_grid_effect">
 	...
 	<div class="about-wthree" id="about">
		  <div class="container">
				   <div class="ab-w3l-spa">
                            <h3 class="title-w3-agileits title-black-wthree">About Our ANNAPURNA</h3> 
...
<div class="team" id="team">
	<div class="container">
			...
			<div id="horizontalTab">
				...
				<li>
						<img src="images/teams3a.jpg" alt=" " class="img-responsive" />
					</li>
					<li>
						<img src="images/teams2a.jpg" alt=" " class="img-responsive" />
					</li>
					...
					<div class="tab1">
						...
						<div class="col-md-6 team-Info-agileits">
							<h4>Atharva Agrawal</h4>
							<span>Manager</span>
							<p>Welcome to HOTEL ANNAPURNA. We promise to provide you a pleasant and wonderful experience. Have a good day! .</p>
...
<section class="contact-w3ls" id="contact">
	<div class="container">
		...
		<div class="col-lg-6 col-md-6 col-sm-6 contact-w3-agile1" data-aos="flip-right">
			...
			<p class="contact-agile1"><strong>Phone :</strong>+91-7426931082</p>
			<p class="contact-agile1"><strong>Email :</strong> <a href="mailto:name@example.com">reemasmu1398@gmail.com</a></p>
			<p class="contact-agile1"><strong>Address :</strong> Durbar Marg,Kathmandu,Nepal</p>
...
<!-- /contact -->
			<div class="copy">
		        <p>© 2020 ANNAPURNA . All Rights Reserved | Design by <a href="index.php">ANNAPURNA</a> </p>
		    </div>
<!--/footer -->
<!-- js -->
